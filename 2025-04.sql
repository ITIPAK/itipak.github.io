...
-- Dumping data for table iso.actionwr: ~27 rows (approximately)
...
INSERT INTO `actionwr` (`nowr`, `schedule`, `action`, `actiondate`, `close`) VALUES
	...
	('WRIPAK/2022-03/0001', 1, 'Pasang kembali Wifi Extender untuk absen', '2022-03-23', 'Y'),
	('WRVIP/2022-03/0001', 1, 'Cabut semua kabel pada power supply, kemudian pasang kembali', '2022-03-28', 'Y'),
	('WRIPAK/2022-04/0001', 1, 'Cabut DDR kemudian pasang kembali', '2022-04-01', 'Y'),
	('WRIPAK/2022-04/0002', 1, 'Cari Data kemudian restore', '2022-04-11', 'Y'),
	('WRIPAK/2022-04/0003', 1, 'Buka Gmail via browser, kemudian ubah settingan', '2022-04-14', 'Y'),
	('WRIPAK/2022-04/0004', 1, 'Update Chrome atau coba menggunakan Opera browser', '2022-04-19', 'Y'),
	('WRIPAK/2022-05/0001', 1, 'Cek kabel pada serial port komputer', '2022-05-24', 'Y'),
	('WRIPAK/2022-06/0001', 1, 'Nyalakan komputer host printer', '2022-06-03', 'Y'),
	('WRIPAK/2022-06/0002', 1, 'Kencangkan baut pada kabel serial timbangan', '2022-06-13', 'Y'),
	('WRVIP/2022-04/0001', 1, 'Restart aplikasi excell', '2022-04-07', 'Y'),
	('WRVIP/2022-04/0002', 1, 'Ubah IP Sesuaikan dengan IP Router', '2022-04-14', 'Y'),
	('WRVIP/2022-04/0003', 1, 'Ganti Adaptor', '2022-04-27', 'Y'),
	('WRVIP/2022-05/0001', 1, 'Buka web Jamsostek pada jam sepi', '2022-05-24', 'Y'),
	('WRVIP/2022-06/0001', 1, 'Kencangkan baut pada kipas casing', '2022-06-09', 'Y'),
	('WRVIP/2022-06/0002', 1, 'Bersihkan Keyboard menggunakan blower', '2022-06-11', 'Y'),
	('WRIPAK/2025-04/0001', 1, 'Print', '2025-04-30', 'Y');
...
INSERT INTO `mscompany` (`idcompany`, `company`, `address`, `phone`, `alias`, `logo`, `qa`, `active`) VALUES
	...
	('vip', 'PT. Vortex Interplasindo', 'Jl. Millenium Raya Blok i3 No 01', '021-5916388', 'VIP', 'vip.jpg', 'Basuki', 'N');
...
INSERT INTO `mscomputer` (`idcomputer`, `idlocation`, `computer`, `os`, `antivirus`, `expired`, `user`, `motherboard`, `processor`, `ram`, `hdd`, `vga`, `casing`, `monitor`, `printer`, `keyboard`, `mouse`, `other`, `iddivisi`, `remark`, `date`, `updatedate`, `ipaddress`, `aktif`) VALUES
	('adm-prod', '', 'Admin - SAS', 'Windows 10', 'Avast', '2021-05-30', 'Juarsih', 'Intel G41', 'Intel Dual Core 3.0 Ghz', 'DDR3 2Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'SAS', 'Cpu Admin & Absen SAS', '2016-07-18', '2020-10-26', '192.168.20.12', 'Y'),
	...
	('asshl-vip', '', 'Assembling  Helm VIP', 'Windows 10', 'Avast Free', '2018-05-30', '-', 'Asus P5GC-MX', 'Intel Dual Core', 'DDR2 1 Gb', '80 Gb', 'no', 'power logic', 'lcd 14 inc', 'Zebra Barcode', 'Logitec', 'Logitec', 'no', 'HELM', 'CPU Assembling 1 VIP', '2017-02-01', '2017-02-01', '192.168.30.13', 'Y'),
	('barhl-vip', '', 'Barcode Helm VIP', 'Windows 10', 'Avast Free', '2018-05-30', '-', 'Asus P5GC-MX', 'Intel Dual Core', 'DDR2 1 Gb', '80 Gb', 'no', 'power logic', 'lcd 14 inc', 'share', 'Logitec', 'Logitec', 'no', 'HELM', 'CPU Barcode Helm VIP', '2017-02-01', '2017-02-01', '192.168.30.16', 'Y'),
	('dechl-vip', '', 'Decal n Paint Helm VIP', 'Windows 10', 'Avast Free', '2018-05-30', '', 'Asus P5GC-MX', 'Intel Dual Core', 'DDR2 1 Gb', '80 Gb', 'no', 'power logic', 'lcd 14 inc', 'share', 'Logitec', 'Logitec', 'no', 'HELM', 'CPU Decal n painting VIP', '2017-02-01', '2017-02-01', '192.168.30.16', 'Y'),
	...
	('head-top', '', 'Produksi - INJ2', 'Windows 10', 'Avast', '2018-05-30', 'Dedi', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'TOP', 'Cpu Kepala Produksi TOP', '2016-07-18', NULL, '192.168.21.11', 'Y'),
	...
	('lab1-agp', '', 'Lab 1 - Rubber', 'Windows 10', 'Avast', '2018-05-30', '-', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'AGP', 'Cpu Laboratorium Karet 3 AGP', '2016-07-18', NULL, '192.168.20.53', 'N'),
	('lab2-agp', '', 'Lab 2 - Rubber', 'Windows 10', 'Avast', '2018-05-30', '-', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Epson LX300', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'AGP', 'Cpu Mixing AGP', '2016-07-18', NULL, '192.168.20.66', 'N'),
	('lab3-agp', '', 'Lab3 - Rubber', 'Windows 10', 'Avast', '2018-05-30', '-', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Epson L100', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'AGP', 'Cpu PPIC 1 AGP', '2016-07-18', NULL, '192.168.20.61', 'N'),
	('lgt-vip', '', 'Logistic Vortex', 'Windows 10', 'Avast Free', '2021-05-30', 'Rocky', 'Asus P5GC-MX', 'Intel Dual Core', 'DDR2 2 Gb', '80 Gb', 'no', 'power logic', 'lcd 14 inc', 'epson lx 300', 'Logitec', 'Logitec', 'no', 'VIP', 'CPU Surat Jalan VIP', '2017-02-01', '2017-02-01', '192.168.30.2', 'Y'),
	('logistik-sas', '', 'logistik - SAS', 'Windows 10', 'Avast', '2018-05-30', 'Juarsih', 'Asus', 'Intel Dual Core 3.0 Ghz', 'DDR2 1Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Epson L100', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'SAS', 'Cpu Logistik SAS', '2016-07-18', '2017-10-26', '192.168.20.31', 'Y'),
	('mix-agp', '', 'mixing - rubber', 'Windows 10', 'Avast', '2018-05-30', '-', 'Mobo LGA 1155', 'Intel Core i3 2.0 Ghz', 'DDR3 2Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'AGP', 'Cpu Laboratorium Karet 2 AGP', '2016-07-18', NULL, '192.168.20.52', 'N'),
	...
	('modem-sas', '', 'Modem SAS', 'no', 'no', '2018-05-30', 'no', 'Huawei', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'SAS', 'Modem Internet SAS', '2016-07-18', NULL, '192.168.1.1', 'Y'),
	...
	('pabx-cbn2', '', 'pabx - SAS', 'Windows 10', 'Avast', '2018-05-30', '-', 'Asus', 'Intel Dual Core 3.0 Ghz', 'DDR2 1Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'SAS', 'Cpu PABX SAS', '2016-07-18', '2017-10-26', '192.168.20.2', 'N'),
	('ped-sas', '', 'PED - SAS', 'Windows 10', 'Avast', '2021-05-30', 'Gozali', 'Intel H55B - 115x', 'Intel Core i3, 3.0 Ghz', 'DDR3 8Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'SAS', 'Cpu PED SAS', '2016-07-18', '2020-05-30', '192.168.20.15', 'N'),
	('ped-vip', '', 'PED & Admin Prod Vortex', 'Windows 10', 'Avast Free', '2018-05-30', 'Gozali', 'Asus P5GC-MX', 'Intel Dual Core', 'DDR2 1 Gb', '80 Gb', 'no', 'power logic', 'lcd 14 inc', 'no', 'Logitec', 'Logitec', 'no', 'VIP', 'CPU PED VIP', '2017-02-01', '2017-02-01', '192.168.30.6', 'Y'),
	('ppic-agp', '', 'ppic - Rubber', 'Windows 10', 'Avast', '2018-05-30', 'Juarsih', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Epson LX300', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'AGP', 'Cpu Admin Produksi 2 AGP', '2016-07-18', NULL, '192.168.20.63', 'N'),
	('ppic-sas', '', 'ppic - SAS', 'Windows 10', 'Avast', '2021-05-30', 'Dian', 'Intel H55B - 115x', 'Intel Core i3, 3.0 Ghz', 'DDR3 8Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'SAS', 'Cpu PPIC SAS', '2016-07-18', '2020-05-26', '192.168.20.26', 'Y'),
	('ppic-top', '', 'PPIC - INJ2', 'Windows 10', 'Avast', '2018-05-30', 'Lukman', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Epson LX300', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'TOP', 'Cpu PPIC TOP', '2016-07-18', NULL, '192.168.21.31', 'Y'),
	...
	('prod-agp', '', 'produksi - Rubber', 'Windows 10', 'Avast', '2018-05-30', 'Juarsih', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'AGP', 'Cpu Admin Produksi 1 AGP', '2016-07-18', NULL, '192.168.20.62', 'Y'),
	('prod-sas', '', 'produksi - SAS', 'Windows 10', 'Avast', '2021-05-30', 'Dian', 'Intel H55B - 115x', 'Intel Core i3, 3.0 Ghz', 'DDR3 8Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Epson L110', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'SAS', 'Cpu Produksi SAS', '2016-07-18', '2020-10-26', '192.168.20.15', 'Y'),
	('prod1-top', '', 'AdminProd - INJ2', 'Windows 10', 'Avast', '2018-05-30', 'Lukman', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'TOP', 'Cpu Admin produksi TOP', '2016-07-18', NULL, '192.168.21.32', 'Y'),
	('prod2-top', '', 'AdminProd - INJ3', 'Windows 10', 'Avast', '2018-05-30', 'Shinta', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'TOP', 'Cpu Admin produksi 2 TOP', '2016-07-18', '2017-10-26', '192.168.21.32', 'Y'),
	...
	('qaqc-vip', '', 'QA - QC Vortex', 'Windows 10', 'Avast Free', '2018-05-30', '-', 'Asus P5GC-MX', 'Intel Dual Core', 'DDR2 1 Gb', '80 Gb', 'no', 'power logic', 'lcd 14 inc', 'epson lx300', 'Logitec', 'Logitec', 'no', 'VIP', 'CPU QA QC VIP', '2017-02-01', '2017-02-01', '192.168.30.8', 'Y'),
	('qc-sas', '', 'QC - SAS', 'Windows 10', 'Avast', '2021-05-30', '', 'Intel H55B - 115x', 'Intel Dual Core 3.0 Ghz', 'DDR2 1Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Share', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'SAS', 'Cpu QC SAS', '2016-07-18', '2017-10-26', '192.168.20.8', 'N'),
	('qc-top', '', 'QC - INJ2', 'Windows 10', 'Avast', '2018-05-30', 'Shinta', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Epson LX300', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'TOP', 'Cpu QC TOP', '2016-07-18', NULL, '192.168.21.34', 'Y'),
	...
	('timbang-sas', '', 'timbangan - SAS', 'Windows 10', 'Avast', '2021-05-30', 'Juarsih', 'Intel H55B - 115x', 'Intel Core i3, 3.0 Ghz', 'DDR3 4Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Lx300', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'SAS', 'Cpu Timbangan SAS', '2016-07-18', '2020-10-26', '192.168.20.32', 'Y'),
	('vsr-mot', '', 'Visor MOT', 'Windows 10', 'avast Free', '2018-05-30', 'Wardi', 'Asus Lga 775', 'Dual core', 'DDR2 1Gb', '160Gb', 'no', 'power logic', 'LCD 15"', 'Epson L100', 'Logitec', 'Logitec', 'no', 'MOT', 'CPU Admin 3 MOT', '2017-02-16', NULL, '192.168.1.5', 'Y'),
	('wh-agp', '', 'warehouse - Rubber', 'Windows 10', 'Avast', '2018-05-30', 'Sahid', 'Asus', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 160 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Epson L100', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'AGP', 'Cpu Laboratorium Karet 1 AGP', '2016-07-18', NULL, '192.168.20.51', 'Y'),
	('wh-sas', '', 'warehouse - SAS', 'Windows 10', 'Avast', '2018-05-30', 'Juarsih', 'Intel G41', 'Intel Dual Core 3.0 Ghz', 'DDR3 4Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Epson Lx300', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'SAS', 'Cpu Warehouse SAS', '2016-07-18', '2017-10-26', '192.168.20.102', 'N'),
	('wh-top', '', 'AdminWrhs - INJ2', 'Windows 10', 'Avast', '2018-05-30', 'Ahmad', 'gigabyte', 'Intel Dual Core 2.0 Ghz', 'DDR2 1Gb', 'HDD 500 Gb', 'No', 'Power Logic 450W', 'LCD 15"', 'Epson LX300', 'logitech ps2', 'logitech usb', 'Wifi usb Lan', 'TOP', 'Cpu Kepala Produksi TOP', '2016-07-18', NULL, '192.168.21.21', 'Y'),
	('wh1-vip', '', 'Warehouse1 Vortex', 'Windows 10', 'Avast Free', '2018-05-30', 'Rocky', 'Intel G41', 'Intel Dual Core', 'DDR2 2 Gb', '160 Gb', 'no', 'power logic', 'lcd 14 inc', 'epson lx 300', 'Logitec', 'Logitec', 'no', 'VIP', 'CPU Gudang 1', '2017-02-01', '2017-02-01', '192.168.30.3', 'Y'),
	('wh2-vip', '', 'Warehouse2 Vortex', 'Windows 10', 'Avast Free', '2018-05-30', '-', 'Intel G41', 'Intel Core 2 Duo', 'DDR3 4 Gb', '160 Gb', 'no', 'power logic', 'lcd 14 inc', 'epson l100', 'Logitec', 'Logitec', 'no', 'HELM', 'CPU Gudang 2', '2017-02-01', '2017-02-01', '192.168.30.4', 'Y'),
	...
	('wifi1-sas', '', 'Wifi Staff SAS', 'no', 'no', '2018-05-30', 'no', 'tplink', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'SAS', 'Wifi Karyawan SAS', '2016-07-18', NULL, '192.168.1.5', 'Y'),
...
INSERT INTO `msdivisi` (`iddivisi`, `divisi`, `idcompany`, `utama`, `leader`, `location`, `pin`, `email`, `ip`) VALUES
	('SAS', 'Injection 1', 'ipak', 'Y', 'Murdono', 'Jl Manis V - Tangerang', 'e10adc3949ba59abbe56e057f20f883e', 'opunk.janie@gmail.com', ''),
	('AGP', 'Rubber', 'ipak', 'Y', 'Murdono', 'Jl Manis V - Tangerang', 'e10adc3949ba59abbe56e057f20f883e', 'mul.rubber@gmail.com', ''),
	('TOP', 'Injection 2', 'ipak', 'N', 'Sumardi', 'Pasar Kemis - Tangerang', 'e10adc3949ba59abbe56e057f20f883e', 'yance.prodfac@gmail.com', ''),
...
-- Dumping data for table iso.mslocation: ~6 rows (approximately)
/*!40000 ALTER TABLE `mslocation` DISABLE KEYS */;
INSERT INTO `mslocation` (`idlocation`, `idcompany`, `location`, `address`) VALUES
	('manisv', 'ipak', 'Kawasan Manis - Jatake', 'Jl. Manis V No. 18, Jatiuwung Banten'),
	('pk', 'ipak', 'TOP-Pasar Kemis', 'Jl. Pasar Kemis Raya No 78, Banten'),
	('hoi', 'ipak', 'HO-I', 'Ruko Pinangsia Blok I'),
	('hoh', 'ipak', 'HO-H', 'Ruko Pinangsia Blok H'),
	('graha', 'ipak', 'Graha Kencana', 'Komplek Graha Kencana, Kebon Jeruk Jakarta Barat'),
	('millep', 'ipak', 'Millenium Pabrik', 'Jl. Millenium Raya Blok i3 No 01'),
	('milleg', 'ipak', 'Millenium Gudang', 'Jl. Millenium Raya Blok n');
...
-- Dumping data for table iso.mspart: ~28 rows (approximately)
...
-- Dumping data for table iso.mspartstock: ~285 rows (approximately)
...
INSERT INTO `mspartstock` (`idpart`, `date`, `stock`, `idcompany`, `idunit`) VALUES
	...
	('FGPR1', '2022-02-09 12:34:19', -2, NULL, 'pcs'),
	('WIFIOUT1', '2022-02-09 12:34:19', -2, NULL, 'pcs'),
	('FGPR1', '2022-02-10 00:00:00', 0, NULL, 'pcs'),
	('WIFIOUT1', '2022-02-10 00:00:00', 0, NULL, 'pcs'),
	('WIFIUSB', '2022-02-10 12:35:32', 4, NULL, 'pcs'),
	('CSG', '2023-07-18 15:16:36', 2, NULL, 'pcs'),
	('DDR32', '2023-07-18 15:16:36', 2, NULL, 'pcs'),
	('DDR34', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('FGPR1', '2023-07-18 15:16:36', 3, NULL, 'pcs'),
	('HDD1000', '2023-07-18 15:16:36', 1, NULL, 'pcs'),
	('HDD160', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('HDD2000', '2023-07-18 15:16:36', 2, NULL, 'pcs'),
	('HDD250', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('HDD500', '2023-07-18 15:16:36', 2, NULL, 'pcs'),
	('HDD80', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('KYB', '2023-07-18 15:16:36', 3, NULL, 'pcs'),
	('LED15', '2023-07-18 15:16:36', 5, NULL, 'unit'),
	('MB1150', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('MB1155', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('MB775', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('MOS', '2023-07-18 15:16:36', 2, NULL, 'pcs'),
	('PRC2', '2023-07-18 15:16:36', 2, NULL, 'pcs'),
	('PRC3', '2023-07-18 15:16:36', 1, NULL, 'pcs'),
	('PRC4', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('PRC5', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('PRC6', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('PSU45', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('PSU50', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('SSD120', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('SSD240', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('WIFIOUT1', '2023-07-18 15:16:36', 0, NULL, 'pcs'),
	('WIFIUSB', '2023-07-18 15:16:36', 1, NULL, 'pcs'),
	('WINXP', '2023-07-18 15:16:36', 20, NULL, 'cd'),
	('CSG', '2025-04-30 15:08:23', 1, NULL, 'pcs'),
	('DDR32', '2025-04-30 15:08:23', 1, NULL, 'pcs');
...
-- Dumping data for table iso.opnamedt: ~207 rows (approximately)
...
INSERT INTO `opnamedt` (`noop`, `idpart`, `qty`, `idunit`) VALUES
	...
	('OP/2023-07/0001', 'CSG', 2, 'pcs'),
	('OP/2023-07/0001', 'DDR32', 2, 'pcs'),
	('OP/2023-07/0001', 'DDR34', 0, 'pcs'),
	('OP/2023-07/0001', 'FGPR1', 3, 'pcs'),
	('OP/2023-07/0001', 'HDD1000', 1, 'pcs'),
	('OP/2023-07/0001', 'HDD160', 0, 'pcs'),
	('OP/2023-07/0001', 'HDD2000', 2, 'pcs'),
	('OP/2023-07/0001', 'HDD250', 0, 'pcs'),
	('OP/2023-07/0001', 'HDD500', 2, 'pcs'),
	('OP/2023-07/0001', 'HDD80', 0, 'pcs'),
	('OP/2023-07/0001', 'KYB', 3, 'pcs'),
	('OP/2023-07/0001', 'LED15', 5, 'unit'),
	('OP/2023-07/0001', 'MB1150', 0, 'pcs'),
	('OP/2023-07/0001', 'MB1155', 0, 'pcs'),
	('OP/2023-07/0001', 'MB775', 0, 'pcs'),
	('OP/2023-07/0001', 'MOS', 2, 'pcs'),
	('OP/2023-07/0001', 'PRC2', 2, 'pcs'),
	('OP/2023-07/0001', 'PRC3', 1, 'pcs'),
	('OP/2023-07/0001', 'PRC4', 0, 'pcs'),
	('OP/2023-07/0001', 'PRC5', 0, 'pcs'),
	('OP/2023-07/0001', 'PRC6', 0, 'pcs'),
	('OP/2023-07/0001', 'PSU45', 0, 'pcs'),
	('OP/2023-07/0001', 'PSU50', 0, 'pcs'),
	('OP/2023-07/0001', 'SSD120', 0, 'pcs'),
	('OP/2023-07/0001', 'SSD240', 0, 'pcs'),
	('OP/2023-07/0001', 'WIFIOUT1', 0, 'pcs'),
	('OP/2023-07/0001', 'WIFIUSB', 1, 'pcs'),
	('OP/2023-07/0001', 'WINXP', 20, 'cd');
...
INSERT INTO `trgetpartdt` (`nogp`, `idpart`, `qty`, `idunit`, `remark`) VALUES
	...
	('GPSAS/2022-02/0002', 'FGPR1', 2, 'pcs', ''),
	('GPSAS/2022-02/0002', 'WIFIOUT1', 2, 'pcs', ''),
	('GPSAS/2025-04/0001', 'CSG', 1, 'pcs', 'add'),
	('GPSAS/2025-04/0001', 'DDR32', 1, 'pcs', '');
...
-- Dumping data for table iso.trgetparthd: ~5 rows (approximately)
...
INSERT INTO `trgetparthd` (`nogp`, `nowr`, `date`, `remark`) VALUES
	...
	('GPSAS/2022-02/0002', 'WRIPAK/2022-02/0002', '2022-02-10', NULL),
	('GPSAS/2025-04/0001', 'WRIPAK/2025-04/0001', '2025-04-30', NULL);
...
-- Dumping data for table iso.trprdt: ~4 rows (approximately)
...
-- Dumping data for table iso.trprhd: ~3 rows (approximately)
...
-- Dumping data for table iso.trrrdt: ~4 rows (approximately)
...
INSERT INTO `trrrdt` (`norr`, `idpart`, `qty`, `idunit`) VALUES
	...
	('RRIT/2022-02/0003', 'WIFIUSB', 3, 'pcs');
...
-- Dumping data for table iso.trrrhd: ~3 rows (approximately)
...
INSERT INTO `trrrhd` (`norr`, `nopr`, `tanggal`, `remark`) VALUES
	...
	('RRIT/2022-02/0003', 'PRSAS/2022-02/0001', '2022-02-10', '');
...
-- Dumping data for table iso.trwr: ~27 rows (approximately)
...
INSERT INTO `trwr` (`nowr`, `date`, `idcomputer`, `idtech`, `user`, `idcompany`, `iddivisi`, `signature`, `assign`, `issue`, `alasan`, `status`, `closedate`, `getpart`, `request`, `vendor`) VALUES
	...
	('WRIPAK/2022-02/0002', '2022-02-08 11:25:02', 'server-sas', 'IT1', 'Diana', 'ipak', 'SAS', 'Murdono', 'gofur', 'Permintaan Absen System', 'Absen Masih Manual', 'CO', '2022-02-08 12:38:11', 'GPSAS/2022-07/0001', 'PRSAS/2022-02/0002', NULL),
	('WRIPAK/2022-02/0003', '2022-02-25 13:23:54', 'prod-agp', 'IT1', 'Sumi', 'ipak', 'AGP', 'Murdono', 'gofur', 'tidak bisa kirim email', 'Internet gangguan', 'CO', '2022-02-25 15:11:09', NULL, NULL, NULL),
	('WRIPAK/2022-03/0001', '2022-03-23 09:42:17', 'server-sas', 'IT1', 'Diana', 'ipak', 'SAS', 'Murdono', 'gofur', 'Absen tidak bisa ditarik', 'Wifi Extender OFF tercabut', 'CO', '2022-03-23 10:36:52', NULL, NULL, NULL),
	('WRIPAK/2022-04/0001', '2022-04-01 10:21:13', 'logistik-sas', 'IT1', 'Sumi', 'ipak', 'SAS', 'Murdono', 'gofur', 'Komputer layar biru', 'Memory DDR selek', 'CO', '2022-04-01 11:12:01', NULL, NULL, NULL),
	('WRIPAK/2022-04/0002', '2022-04-11 11:54:09', 'ppic-sas', 'IT1', 'Diana', 'ipak', 'SAS', 'Murdono', 'gofur', 'Data Laporan Produksi hilang', 'Perubahan Folder dalam Komputer', 'CO', '2022-04-11 12:44:09', NULL, NULL, NULL),
	('WRIPAK/2022-04/0003', '2022-04-14 08:01:09', 'ped-sas', 'IT1', 'Tisha', 'ipak', 'SAS', 'Murdono', 'gofur', 'Email ped selalu minta password', 'Settingan gmail berubah', 'CO', '2022-04-14 10:29:54', NULL, NULL, NULL),
	('WRIPAK/2022-04/0004', '2022-04-19 07:58:29', 'logistik-sas', 'IT1', 'Sumi', 'ipak', 'SAS', 'Murdono', 'gofur', 'Buka web SCS Suzuki Gagal', 'Browser chrome belum update', 'CO', '2022-04-19 09:31:36', NULL, NULL, NULL),
	('WRIPAK/2022-05/0001', '2022-05-24 07:55:23', 'timbang-sas', 'IT1', 'Sumi', 'ipak', 'SAS', 'Murdono', 'gofur', 'Error angka timbangan', 'Port serial kendor', 'CO', '2022-05-24 09:51:23', NULL, NULL, NULL),
	('WRIPAK/2022-06/0001', '2022-06-03 09:16:49', 'ppic-sas', 'IT1', 'Diana', 'ipak', 'SAS', 'Murdono', 'gofur', 'Ga bisa print ke LX300', 'Komputer host masih off', 'CO', '2022-06-03 09:59:38', NULL, NULL, NULL),
	('WRIPAK/2022-06/0002', '2022-06-13 11:02:22', 'timbang-sas', 'IT1', 'Sumi', 'ipak', 'SAS', 'Murdono', 'gofur', 'Pesan Error Kesalahan Port', 'Kabel port pada timbangan kendor', 'CO', '2022-06-13 12:14:22', NULL, NULL, NULL),
	('WRIPAK/2025-04/0001', '2025-04-30 15:07:34', 'wifi1-sas', 'IT1', 'Anak Baru', 'ipak', 'SAS', 'Murdono', 'gofur', 'Ga Bisa Priint', 'Printer Erer\r\n', 'CO', '2025-04-30 15:10:45', 'GPSAS/2025-04/0001', NULL, NULL),
	...
	('WRVIP/2022-02/0001', '2022-02-16 13:21:27', 'lgt-vip', 'IT1', 'Roky', 'vip', 'VIP', 'Basuki', 'gofur', 'Komputer Panas', 'Kipas processor kurang berputar', 'CO', '2022-02-16 14:11:29', NULL, NULL, NULL),
	('WRVIP/2022-02/0002', '2022-02-21 08:35:05', 'admhl-vip', 'IT1', 'Dian', 'vip', 'HELM', 'Triyono', 'gofur', 'Hasil print garis-garis', 'Head print kotor', 'CO', '2022-02-21 08:45:23', NULL, NULL, NULL),
	('WRVIP/2022-02/0003', '2022-02-23 07:59:10', 'wifi2-vip', 'IT1', 'Nela', 'vip', 'VIP', 'Basuki', 'gofur', 'Wifi untuk tamu tidak bisa koneksi', 'Kabel di modem sedikit kendor', 'CO', '2022-02-23 08:58:20', NULL, NULL, NULL),
	('WRVIP/2022-03/0001', '2022-03-28 12:47:33', 'wh2-vip', 'IT1', 'Sofani', 'vip', 'VIP', 'Basuki', 'gofur', 'Komputer tidak menyala', 'Power Supply kurang stabil', 'CO', '2022-03-28 13:57:28', NULL, NULL, NULL),
	('WRVIP/2022-04/0001', '2022-04-07 14:10:57', 'qaqc-vip', 'IT1', 'Gozali', 'vip', 'VIP', 'Basuki', 'gofur', 'excel blank putih', 'excell gagal startup', 'CO', '2022-04-07 15:21:34', NULL, NULL, NULL),
	('WRVIP/2022-04/0002', '2022-04-14 11:47:01', 'dsn1-vip', 'IT1', 'Dimas', 'vip', 'VIP', 'Basuki', 'gofur', 'Internet putus', 'IP wifi tidak syncron', 'CO', '2022-04-14 13:12:07', NULL, NULL, NULL),
	('WRVIP/2022-04/0003', '2022-04-27 08:11:45', 'modem-vip', 'IT1', 'Nela', 'vip', 'VIP', 'Basuki', 'gofur', 'Modem Mati', 'Adaptor rusak', 'CO', '2022-04-27 09:31:56', NULL, NULL, NULL),
	('WRVIP/2022-05/0001', '2022-05-24 08:12:03', 'hrd-vip', 'IT1', 'Diana', 'vip', 'VIP', 'Basuki', 'gofur', 'Web jamsostek ga bisa dibuka', 'Akses Web jamsostek full', 'CO', '2022-05-24 09:34:01', NULL, NULL, NULL),
	('WRVIP/2022-06/0001', '2022-06-08 12:56:32', 'svr-vip', 'IT1', 'Dian', 'vip', 'VIP', 'Basuki', 'gofur', 'Server berisik saat nyala', 'Baut kipas casing kendor', 'CO', '2022-06-08 14:22:30', NULL, NULL, NULL),
	('WRVIP/2022-06/0002', '2022-06-11 09:01:29', 'wh1-vip', 'IT1', 'Roky', 'vip', 'VIP', 'Basuki', 'gofur', 'Keyboard komputer keras', 'Keyboard Kotor', 'CO', '2022-06-11 10:14:09', NULL, NULL, NULL);
...
-- Dumping data for table iso.wrschedule: ~27 rows (approximately)
...
INSERT INTO `wrschedule` (`nowr`, `date`, `idcompany`, `iddivisi`, `schedule`) VALUES
	...
	('WRIPAK/2022-03/0001', '2022-03-23', 'ipak', 'SAS', 1),
	('WRVIP/2022-03/0001', '2022-03-28', 'vip', 'VIP', 1),
	('WRIPAK/2022-04/0001', '2022-04-01', 'ipak', 'SAS', 1),
	('WRIPAK/2022-04/0002', '2022-04-11', 'ipak', 'SAS', 1),
	('WRIPAK/2022-04/0003', '2022-04-14', 'ipak', 'SAS', 1),
	('WRIPAK/2022-04/0004', '2022-04-19', 'ipak', 'SAS', 1),
	('WRVIP/2022-04/0001', '2022-04-07', 'vip', 'VIP', 1),
	('WRVIP/2022-04/0002', '2022-04-14', 'vip', 'VIP', 1),
	('WRVIP/2022-04/0003', '2022-04-27', 'vip', 'VIP', 1),
	('WRIPAK/2022-05/0001', '2022-05-24', 'ipak', 'SAS', 1),
	('WRVIP/2022-05/0001', '2022-05-24', 'vip', 'VIP', 1),
	('WRVIP/2022-06/0001', '2022-06-08', 'vip', 'VIP', 1),
	('WRVIP/2022-06/0002', '2022-06-11', 'vip', 'VIP', 1),
	('WRIPAK/2022-06/0001', '2022-06-03', 'ipak', 'SAS', 1),
	('WRIPAK/2022-06/0002', '2022-06-13', 'ipak', 'SAS', 1),
	('WRIPAK/2025-04/0001', '2025-04-30', 'ipak', 'SAS', 1);
