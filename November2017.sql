...
-- Dumping data for table iso.actionwr: ~21 rows (approximately)
/*!40000 ALTER TABLE `actionwr` DISABLE KEYS */;
INSERT INTO `actionwr` (`nowr`, `schedule`, `action`, `actiondate`, `close`) VALUES
	('WRIPAK/2017-02/0001', 1, 'Ganti Power Supply', '2017-02-01', 'Y'),
	('WRIPAK/2017-03/0001', 1, 'Restart Wifi - Instruksi Via Telp', '2017-03-12', 'Y'),
	('WRIPAK/2017-03/0002', 1, 'Backup Database Aplikasi. & Install Ulang Aplikasi', '2017-03-16', 'Y'),
	('WRIPAK/2017-05/0001', 1, 'Ganti Harddisk', '2017-05-02', 'Y'),
	('WRIPAK/2017-05/0002', 1, 'Cabut, kemudian pasang kembali wifi usb dengan benar ', '2017-05-12', 'Y'),
	('WRIPAK/2017-06/0001', 1, 'Charge Batre, kemudian nyalakan modem.', '2017-06-15', 'Y'),
	('WRIPAK/2017-04/0001', 1, 'Matikan dan Nyalakan Kembali Router', '2017-04-20', 'Y'),
	('WRIPAK/2017-06/0002', 1, 'Ganti Semua Kabel Listrik', '2017-06-30', 'Y'),
	('WRIPAK/2017-07/0001', 1, 'Ganti Power Supply', '2017-07-10', 'Y'),
	('WRIPAK/2017-08/0001', 1, 'Konfirm ke pihak Telkom', '2017-08-25', 'Y'),
	('WRIPAK/2017-09/0001', 1, 'Gude Via telp cara ubah Password', '2017-09-05', 'Y'),
	('WRIPAK/2017-10/0001', 1, 'Memastikan kabel telp terpasang di pabx', '2017-10-03', 'Y'),
	('WRVIP/2017-04/0003', 1, 'Restart Paksa CPU Share', '2017-02-23', 'Y'),
	('WRVIP/2017-03/0001', 1, 'Ganti Motherboard & Install Ulang', '2017-03-13', 'Y'),
	('WRVIP/2017-02/0001', 1, 'Restart Modem Speedy', '2017-04-03', 'Y'),
	('WRVIP/2017-04/0001', 1, 'Install Ulang Windows', '2017-04-18', 'Y'),
	('WRVIP/2017-04/0002', 1, 'Cabut Pasang Usb Wifi', '2017-04-19', 'Y'),
	('WRVIP/2017-06/0001', 1, 'Upgrade Memory', '2017-06-22', 'Y'),
	('WRVIP/2017-06/0002', 1, 'Ganti Power Supply', '2017-06-24', 'Y'),
	('WRVIP/2017-08/0001', 1, 'Kirim & Terima Email via Outlook', '2017-08-10', 'Y'),
	('WRVIP/2017-09/0001', 1, 'Bersihkan Printer via Aplikasi', '2017-09-22', 'Y');
...
INSERT INTO `msdivisi` (`iddivisi`, `divisi`, `idcompany`, `utama`, `leader`, `location`, `pin`, `email`, `ip`) VALUES
	...
	('VIP', 'Injection', 'vip', 'Y', 'Ika', 'Jl Manis Raya - Tangerang', '14e1b600b1fd579f47433b88e8d85291', 'iis.sholicha@gmail.com', '192.168.10.2'),
	...
	('HO1', 'Kantor', 'ipak', 'N', 'Wina', 'Graha Kencana Kebon Jeruk', 'e10adc3949ba59abbe56e057f20f883e', 'wina_accho@yahoo.co.id', '192.168.10.247'),
...
-- Dumping data for table iso.mspart: ~25 rows (approximately)
...
-- Dumping data for table iso.mspartstock: ~31 rows (approximately)
...
INSERT INTO `mspartstock` (`idpart`, `date`, `stock`, `idcompany`, `idunit`) VALUES
	...
	('PSU45', '2017-07-10 07:04:07', 4, NULL, 'pcs'),
	('MB1150', '2017-03-13 00:00:00', 0, NULL, 'pcs'),
	('DDR21', '2017-06-22 00:00:00', 0, NULL, 'pcs'),
	('PSU45', '2017-06-29 00:00:00', 3, NULL, 'pcs');
...
-- Dumping data for table iso.trgetpartdt: ~6 rows (approximately)
...
INSERT INTO `trgetpartdt` (`nogp`, `idpart`, `qty`, `idunit`, `remark`) VALUES
	...
	('GPVIP/2017-03/0001', 'MB1150', 1, 'pcs', ''),
	('GPVIP/2017-06/0001', 'DDR21', 1, 'pcs', ''),
	('GPVIP/2017-06/0002', 'PSU45', 1, 'pcs', '');
...
INSERT INTO `trgetparthd` (`nogp`, `nowr`, `date`, `remark`) VALUES
	...
	('GPVIP/2017-03/0001', 'WRVIP/2017-03/0001', '2017-03-13', NULL),
	('GPVIP/2017-06/0001', 'WRVIP/2017-06/0001', '2017-06-22', NULL),
	('GPVIP/2017-06/0002', 'WRVIP/2017-06/0002', '2017-06-24', NULL);
...
INSERT INTO `trprdt` (`nopr`, `idpart`, `qty`, `idunit`, `remark`) VALUES
	('PRVIP/2017-03/0001', 'MB1150', 1, 'pcs', '');
...
INSERT INTO `trprhd` (`nopr`, `nowr`, `tanggal`, `remark`, `status`) VALUES
	('PRVIP/2017-03/0001', 'WRVIP/2017-03/0001', '2017-03-13', '', 'O');
...
-- Dumping data for table iso.trwr: ~21 rows (approximately)
...
INSERT INTO `trwr` (`nowr`, `date`, `idcomputer`, `idtech`, `user`, `idcompany`, `iddivisi`, `signature`, `assign`, `issue`, `alasan`, `status`, `closedate`, `getpart`, `request`, `vendor`) VALUES
	...
	('WRVIP/2017-02/0001', '2017-02-23 14:14:10', 'hrd-vip', 'IT1', 'Entin', 'vip', 'VIP', 'Basuki', 'gofur', 'Internet Error', 'Modem Panas', 'CO', '2017-02-23 16:06:48', NULL, NULL, NULL),
	('WRVIP/2017-03/0001', '2017-03-13 12:45:18', 'hrd-vip', 'IT1', 'entin', 'vip', 'VIP', 'Basuki', 'gofur', 'komputer minta ganti', 'Motherboard Error', 'CO', '2017-03-13 15:22:15', 'GPVIP/2017-03/0001', 'PRVIP/2017-03/0001', NULL),
	('WRVIP/2017-04/0001', '2017-04-03 13:39:11', 'dsn2-vip', 'IT1', 'Nella', 'vip', 'VIP', 'Basuki', 'gofur', 'PC ga bisa Login', 'Windows Error', 'CO', '2017-04-03 15:17:06', NULL, NULL, NULL),
	('WRVIP/2017-04/0002', '2017-04-18 10:19:54', 'svrvip', 'IT1', 'Ika', 'vip', 'VIP', 'Basuki', 'gofur', 'CPU Ga bisa Internet', 'Wifi Lan Error', 'CO', '2017-04-18 12:11:37', NULL, NULL, NULL),
	('WRVIP/2017-04/0003', '2017-04-19 11:09:02', 'wh1-vip', 'IT1', 'Narko', 'vip', 'VIP', 'Basuki', 'gofur', 'CPU ga bisa share Print', 'CPU Share Hang', 'CO', '2017-04-19 14:03:32', NULL, NULL, NULL),
	('WRVIP/2017-06/0001', '2017-06-22 09:02:02', 'ppichl-vip', 'IT1', 'Nela', 'vip', 'VIP', 'Triono', 'gofur', 'CPU Lambat', 'Memory Rendah', 'CO', '2017-06-22 12:35:08', 'GPVIP/2017-06/0001', NULL, NULL),
	('WRVIP/2017-06/0002', '2017-06-24 08:32:03', 'qa-vip', 'IT1', 'Ani', 'vip', 'VIP', 'Basuki', 'gofur', 'Komputer ga Nyala', 'Power Supply Rusak', 'CO', '2017-06-24 10:22:22', 'GPVIP/2017-06/0002', NULL, NULL),
	('WRVIP/2017-08/0001', '2017-08-10 09:21:17', 'qc-vip', 'IT1', 'Ani', 'vip', 'VIP', 'Basuki', 'gofur', 'Email Gagal Kirim', 'Email Via Browser Di kunci', 'CO', '2017-08-10 14:40:06', NULL, NULL, NULL),
	('WRVIP/2017-09/0001', '2017-09-22 11:36:17', 'ppicinj-vip', 'IT1', 'Ani', 'vip', 'VIP', 'Basuki', 'gofur', 'Print Bergaris', 'Head Print Kotor', 'CO', '2017-09-22 16:23:29', NULL, NULL, NULL);
...
INSERT INTO `wrschedule` (`nowr`, `date`, `idcompany`, `iddivisi`, `schedule`) VALUES
	...
	('WRVIP/2017-02/0001', '2017-02-23', 'vip', 'VIP', 1),
	('WRVIP/2017-03/0001', '2017-03-13', 'vip', 'VIP', 1),
	('WRVIP/2017-04/0001', '2017-04-03', 'vip', 'VIP', 1),
	('WRVIP/2017-04/0002', '2017-04-18', 'vip', 'VIP', 1),
	('WRVIP/2017-04/0003', '2017-04-19', 'vip', 'VIP', 1),
	('WRVIP/2017-06/0001', '2017-06-22', 'vip', 'VIP', 1),
	('WRVIP/2017-06/0002', '2017-06-24', 'vip', 'VIP', 1),
	('WRVIP/2017-08/0001', '2017-08-10', 'vip', 'VIP', 1),
	('WRVIP/2017-09/0001', '2017-09-22', 'vip', 'VIP', 1);
