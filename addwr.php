...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>
		...
		<form method="post" action="addwr.php">
		<?php
			if (!empty($no))
			{
		...
		?>
			...
			<tr valign="middle" align="center">
				<td colspan="6"><br><br>
					...
					<input type="hidden" name="nowr" value="<?php echo "$newno"; ?>">
					<input type="text" name="nowr2" value="<?php echo "$newno"; ?>" disabled> <br><br>

				</td>
			</tr>
			
			<tr align="justify">	
				<th><font face="Arial" size="1"><b>WR Date</b></font></th> <th><font face="Arial" size="1"><b>:</b></font></th> <td><input type="hidden" name="date" value="<?php echo "$printdate"; ?>"><input type="text" name="date2" value="<?php echo "$nowdate"; ?>" disabled></td> 	
					...
					<td>
						<select name="idcomputer">
							...
							<?php
								if (!empty($divisi))
								{
									$getcpu = "select * from mscomputer where iddivisi = '$divisi' and aktif ='Y' order by ipaddress";
									$qgetcpu = mysql_query($getcpu);
			...
			<tr align="justify"> 
				...
				<th><font face="Arial" size="1"><b>Sign by</b></font></th> <th><font face="Arial" size="1"><b>:</b></font></th> 
					<td>
						...
						<select name="divisi" onChange="submit()">
						<?php 
						if (!empty($divisi))
						{
