...
-- Dumping data for table iso.actionwr: ~26 rows (approximately)
...
-- Dumping data for table iso.mspart: ~32 rows (approximately)
...
-- Dumping data for table iso.mspartstock: ~283 rows (approximately)
...
-- Dumping data for table iso.trgetpartdt: ~5 rows (approximately)
...
-- Dumping data for table iso.trgetparthd: ~4 rows (approximately)
...
-- Dumping data for table iso.trwr: ~26 rows (approximately)
...
-- Dumping data for table iso.wrschedule: ~26 rows (approximately)
