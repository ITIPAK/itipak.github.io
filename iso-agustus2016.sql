...
-- Dumping structure for table iso1.actionwr
...
-- Dumping data for table iso1.actionwr: ~7 rows (approximately)
/*!40000 ALTER TABLE `actionwr` DISABLE KEYS */;
INSERT INTO `actionwr` (`nowr`, `schedule`, `action`, `actiondate`, `close`) VALUES
	('WRIPAK/2016-06/0001', 1, 'Buat PR Request yang baru.', '2016-06-03', 'N'),
	('WRIPAK/2016-06/0001', 2, 'Ganti Matherboard dan Memory DDR3.', '2016-06-07', 'Y'),
	('WRIPAK/2016-06/0002', 1, 'Buka PR Power Supply', '2016-06-03', 'N'),
	('WRIPAK/2016-06/0002', 2, 'Ganti Power Supply dengan yang Baru', '2016-06-08', 'Y'),
	('WRIPAK/2016-06/0003', 1, 'Off Wifi Router 3 Menit, kemudian ON kembali', '2016-06-06', 'Y'),
	('WRIPAK/2016-06/0004', 1, 'Off Wifi Router 3 menit, kemudian ON kembali.', '2016-06-06', 'Y'),
	('WRIPAK/2016-06/0005', 1, 'Pasang kembali USB wifi dengan Benar.', '2016-06-06', 'Y');
/*!40000 ALTER TABLE `actionwr` ENABLE KEYS */;


-- Dumping structure for table iso1.mscompany
...
-- Dumping data for table iso1.mscompany: ~2 rows (approximately)
...
-- Dumping structure for table iso1.mscompanyld
...
-- Dumping data for table iso1.mscompanyld: ~5 rows (approximately)
...
-- Dumping structure for table iso1.mscomputer
...
-- Dumping data for table iso1.mscomputer: ~38 rows (approximately)
...
-- Dumping structure for table iso1.msdivisi
...
-- Dumping data for table iso1.msdivisi: ~8 rows (approximately)
...
-- Dumping structure for table iso1.mslocation
...
-- Dumping data for table iso1.mslocation: ~5 rows (approximately)
...
-- Dumping structure for table iso1.mslogin
...
-- Dumping data for table iso1.mslogin: ~4 rows (approximately)
...
-- Dumping structure for table iso1.mspart
...
-- Dumping data for table iso1.mspart: ~23 rows (approximately)
...
-- Dumping structure for table iso1.mspartstock
...
-- Dumping data for table iso1.mspartstock: ~89 rows (approximately)
...
-- Dumping structure for table iso1.mstech
...
-- Dumping data for table iso1.mstech: ~3 rows (approximately)
...
-- Dumping structure for table iso1.msunit
...
-- Dumping data for table iso1.msunit: ~3 rows (approximately)
...
-- Dumping structure for table iso1.opnamedt
...
-- Dumping data for table iso1.opnamedt: ~23 rows (approximately)
...
-- Dumping structure for table iso1.opnamehd
...
-- Dumping data for table iso1.opnamehd: ~4 rows (approximately)
...
-- Dumping structure for table iso1.trgetpartdt
...
-- Dumping data for table iso1.trgetpartdt: ~3 rows (approximately)
...
-- Dumping structure for table iso1.trgetpartdt2
...
-- Dumping data for table iso1.trgetpartdt2: ~0 rows (approximately)
/*!40000 ALTER TABLE `trgetpartdt2` DISABLE KEYS */;
/*!40000 ALTER TABLE `trgetpartdt2` ENABLE KEYS */;


-- Dumping structure for table iso1.trgetparthd
...
-- Dumping data for table iso1.trgetparthd: ~2 rows (approximately)
...
-- Dumping structure for table iso1.trprdt
...
-- Dumping data for table iso1.trprdt: ~3 rows (approximately)
...
-- Dumping structure for table iso1.trprhd
...
-- Dumping data for table iso1.trprhd: ~2 rows (approximately)
...
-- Dumping structure for table iso1.trrrdt
...
-- Dumping data for table iso1.trrrdt: ~3 rows (approximately)
...
-- Dumping structure for table iso1.trrrhd
...
-- Dumping data for table iso1.trrrhd: ~2 rows (approximately)
...
-- Dumping structure for table iso1.trwr
...
-- Dumping data for table iso1.trwr: ~5 rows (approximately)
...
INSERT INTO `trwr` (`nowr`, `date`, `idcomputer`, `idtech`, `user`, `idcompany`, `iddivisi`, `signature`, `datesignature`, `assign`, `issue`, `alasan`, `status`, `closedate`, `getpart`, `request`, `vendor`) VALUES
	('WRIPAK/2016-06/0001', '2016-06-01', 'inj-whs2', 'IT1', 'Nomi', 'ipak', 'SAS', 'Drajat', '2016-06-01', 'gofur', 'CPU Mati Total', 'Matherboard Rusak', 'CO', '2016-06-07', 'GPSAS/2016-06/0001', 'PRSAS/2016-06/0001', NULL),
	('WRIPAK/2016-06/0002', '2016-06-01', 'inj-prod1', 'IT1', 'Drajat', 'ipak', 'SAS', 'Drajat', '2016-06-01', 'gofur', 'Power OFF', 'Power Supply Rusak.', 'CO', '2016-06-08', 'GPSAS/2016-06/0002', 'PRSAS/2016-06/0002', NULL),
	('WRIPAK/2016-06/0003', '2016-06-02', 'inj-ppic1', 'IT1', 'Laras', 'ipak', 'SAS', 'Drajat', '2016-06-02', 'gofur', 'Share Data Gagal.', 'Wifi Router Overheat.', 'CO', '2016-06-06', NULL, NULL, NULL),
	('WRIPAK/2016-06/0004', '2016-06-02', 'rub-ppic1', 'IT1', 'Fitri', 'ipak', 'AGP', 'Mulyono', '2016-06-02', 'gofur', 'Email di Outlook Ga bisa.', 'Wifi Router Overheat.', 'CO', '2016-06-06', NULL, NULL, NULL),
	('WRIPAK/2016-06/0005', '2016-06-02', 'rub-adm2', 'IT1', 'Ema', 'ipak', 'AGP', 'Mulyono', '2016-06-02', 'gofur', 'Print Laporan ga bisa.', 'Wifi USB Cpu Lepas', 'CO', '2016-08-09', NULL, NULL, NULL);
/*!40000 ALTER TABLE `trwr` ENABLE KEYS */;


-- Dumping structure for table iso1.wrschedule
...
-- Dumping data for table iso1.wrschedule: ~7 rows (approximately)
