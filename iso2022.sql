...
-- Dumping data for table iso.actionwr: ~34 rows (approximately)
...
-- Dumping data for table iso.mspartstock: ~213 rows (approximately)
...
-- Dumping data for table iso.opnamedt: ~127 rows (approximately)
...
-- Dumping data for table iso.opnamehd: ~8 rows (approximately)
...
-- Dumping data for table iso.trwr: ~43 rows (approximately)
