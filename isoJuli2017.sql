...
--
-- Host: 127.0.0.1
-- Generation Time: 19 Jul 2017 pada 04.53
...
--
-- Dumping data untuk tabel `actionwr`
--
...
('WRVIP/2017-04/0002', 1, 'Buka PR Wifi', '2017-06-12', 'N'),
('WRVIP/2017-07/0001', 1, 'Off Wifi, Kemudian On kembali', '2017-07-15', 'Y'),
('WRVIP/2017-07/0002', 1, 'Ganti Harddisk', '2017-07-15', 'Y'),
('WRVIP/2017-07/0003', 1, 'hahah', '2017-07-15', 'N'),
('WRVIP/2017-07/0003', 2, 'hjsdgsgudgfdddd', '2017-07-15', 'Y'),
('WRVIP/2017-04/0002', 2, 'tester', '2017-07-15', 'N');
...
--
-- Dumping data untuk tabel `changedt`
--

INSERT INTO `changedt` (`nocp`, `idpart`, `qty`, `idunit`) VALUES
('CP/2017-04/0001', 'CSG', 1, 'pcs'),
('CP/2017-04/0001', 'DDR31', 1, 'pcs'),
('CP/2017-04/0001', 'HDD80', 1, 'pcs'),
('CP/2017-04/0001', 'KYB', 1, 'pcs'),
('CP/2017-04/0001', 'PRC3', 1, 'pcs'),
('CP/2017-04/0001', 'PSU45', 1, 'pcs');
...
('HO1', 'Kantor', 'ipak', 'N', 'Wina', 'Graha Kencana Kebon Jeruk', 'e10adc3949ba59abbe56e057f20f883e', 'wina_accho@yahoo.co.id', '192.168.43.102'),
...
('PRC4', 'Intel Dual Core 3.0Ghz 1150', 'Intel Dual Core Socket 1150', 'IT1', 'pcs', 'Y'),
('PRC5', 'Intel Core i3 3.0 Ghz 1150', 'Intel Core i3 Socket 1150', 'IT1', 'pcs', 'Y'),
('PSU45', 'Power Supply 450W', 'Power Supply CPU 450W', 'IT1', 'pcs', 'Y'),
('PSU50', '	Power Supply 500W', 'Power Supply CPU 500W', 'IT1', 'pcs', 'Y'),
('wifi1', 'Wifi LAN', 'Wifi Usb', 'IT1', 'pcs', 'Y'),
...
('CSG', '2017-04-29 10:57:21', 6, NULL, 'pcs'),
('DDR31', '2017-04-29 10:57:21', 1, NULL, 'pcs'),
('HDD80', '2017-04-29 10:57:21', 1, NULL, 'pcs'),
('KYB', '2017-04-29 10:57:21', 1, NULL, 'pcs'),
('PRC3', '2017-04-29 10:57:21', 2, NULL, 'pcs'),
('PSU45', '2017-04-29 10:57:21', 2, NULL, 'pcs'),
('PRC4', '2017-05-02 00:00:00', 0, 'ipak', 'pcs'),
('PRC4', '2017-05-02 00:00:00', 0, 'vip', 'pcs'),
('PRC5', '2017-05-02 00:00:00', 0, 'ipak', 'pcs'),
('PRC5', '2017-05-02 00:00:00', 0, 'vip', 'pcs'),
('DDR32', '2017-05-12 14:34:28', 1, NULL, 'pcs'),
('KYB', '2017-05-12 14:34:28', 2, NULL, 'pcs'),
('MB1150', '2017-05-12 14:34:28', 1, NULL, 'pcs'),
('MOS', '2017-05-12 14:34:28', 2, NULL, 'pcs'),
('PRC4', '2017-05-12 14:34:28', 1, NULL, 'pcs'),
('HDD500', '2017-05-12 14:34:28', 5, NULL, 'pcs'),
('wifi1', '2017-06-11 00:00:00', 0, 'ipak', 'pcs'),
('wifi1', '2017-06-11 00:00:00', 0, 'vip', 'pcs'),
('HDD500', '2017-07-15 12:11:31', 4, NULL, 'pcs'),
('HDD1000', '2017-07-15 13:49:06', 1, NULL, 'pcs'),
('HDD1000', '2017-07-15 13:50:09', 0, NULL, 'pcs');
...
--
-- Dumping data untuk tabel `opnamedt`
--
...
--
-- Dumping data untuk tabel `opnamehd`
--
...
--
-- Dumping data untuk tabel `trgetpartdt`
--
...
('GPHELM/2017-07/0001', 'HDD500', 1, 'pcs', ''),
('GPVIP/2017-07/0001', 'HDD1000', 1, 'pcs', '');
...
('GPVIP/2017-07/0001', 'WRVIP/2017-07/0003', '2017-07-15', NULL);
...
--
-- Dumping data untuk tabel `trprdt`
--
...
('PRIT/2017-05/0001', 'MB1150', 1, 'pcs', ''),
('PRIT/2017-05/0001', 'KYB', 1, 'pcs', ''),
('PRIT/2017-05/0001', 'MOS', 1, 'pcs', ''),
('PRIT/2017-05/0001', 'HDD500', 1, 'pcs', ''),
('PRIT/2017-05/0001', 'PRC4', 1, 'pcs', ''),
('PRIT/2017-05/0001', 'DDR32', 1, 'pcs', ''),
('PRVIP/2017-07/0001', 'HDD1000', 1, 'pcs', ''),
('PRVIP/2017-07/0002', 'HDD1000', 2, 'pcs', '');
...
--
-- Dumping data untuk tabel `trprhd`
--

INSERT INTO `trprhd` (`nopr`, `nowr`, `tanggal`, `remark`, `status`) VALUES
('PRIT/2017-05/0001', 'xxxx', '2017-05-02', 'Untuk Rakit PC PED Mille', 'C'),
...
('PRVIP/2017-07/0001', 'WRVIP/2017-07/0003', '2017-07-15', 'urgent men ', 'C'),
('PRVIP/2017-07/0002', 'WRVIP/2017-04/0002', '2017-07-15', 'Tambahan', 'CA');
...
--
-- Dumping data untuk tabel `trrrdt`
--
...
('RR/2017-05/0001', 'DDR32', 1, 'pcs'),
('RR/2017-05/0001', 'KYB', 1, 'pcs'),
('RR/2017-05/0001', 'MB1150', 1, 'pcs'),
('RR/2017-05/0001', 'MOS', 1, 'pcs'),
('RR/2017-05/0001', 'PRC4', 1, 'pcs'),
('RR/2017-05/0001', 'HDD500', 1, 'pcs'),
('RRIT/2017-07/0001', 'HDD1000', 1, 'pcs');
...
--
-- Dumping data untuk tabel `trrrhd`
--

INSERT INTO `trrrhd` (`norr`, `nopr`, `tanggal`, `remark`) VALUES
('RR/2017-05/0001', 'PRIT/2017-05/0001', '2017-05-12', ''),
('RRIT/2017-07/0001', 'PRVIP/2017-07/0001', '2017-07-15', ''),
...
('WRVIP/2017-04/0002', '2017-04-16 00:00:00', 'svrvip', 'IT1', 'Ika', 'vip', 'VIP', 'Ika', 'gofur', 'CPU Ga bisa Internet', 'wifi rusak. Harus buka PR', 'P', NULL, 'GPVIP/2017-04/0002', 'PRVIP/2017-07/0002', NULL),
...
('WRVIP/2017-05/0001', '2017-05-02 10:22:17', 'ppichl-vip', 'IT1', 'Nella', 'vip', 'HELM', 'Triyono', NULL, 'CPU mati', NULL, 'O', NULL, NULL, NULL, NULL),
('WRVIP/2017-05/0002', '2017-05-02 10:48:22', 'ppichl-vip', 'IT1', 'Nela', 'vip', 'HELM', 'Triyono', NULL, 'Lampu Wifi OFF', NULL, 'O', NULL, NULL, NULL, NULL),
('WRVIP/2017-05/0003', '2017-05-02 10:52:05', 'ped-vip', 'IT1', 'Gozali', 'vip', 'VIP', 'Ika', NULL, 'Monitor OFF', NULL, 'O', NULL, NULL, NULL, NULL),
('WRVIP/2017-05/0004', '2017-05-02 11:13:47', 'decl-vip', 'IT1', 'Mutia', 'vip', 'HELM', 'Triyono', NULL, 'Casing Bau Terbakar', NULL, 'O', NULL, NULL, NULL, NULL),
('WRVIP/2017-05/0005', '2017-05-30 14:49:24', 'ppichl-vip', 'IT1', 'ika', 'vip', 'HELM', 'Triyono', NULL, '&&&&&&&', NULL, 'CA', '2017-05-30 00:00:00', NULL, NULL, NULL),
('WRVIP/2017-05/0006', '2017-05-30 14:57:59', 'admhl-vip', 'IT1', 'iaaa', 'vip', 'HELM', 'Triyono', 'ika', '%%%', NULL, 'P', NULL, NULL, NULL, NULL),
('WRVIP/2017-05/0007', '2017-05-30 14:58:50', 'admhl-vip', 'IT1', 'ika', 'vip', 'HELM', 'Triyono', '0', '8', NULL, 'O', NULL, NULL, NULL, NULL),
('WRVIP/2017-07/0001', '2017-07-15 09:30:08', 'admhl-vip', 'IT1', 'Nela', 'vip', 'HELM', 'Triyono', 'ika', 'Cpu Ga bisa Konek Email', 'Wifi Panas', 'CO', '2017-07-15 12:10:26', NULL, NULL, NULL),
('WRVIP/2017-07/0002', '2017-07-15 12:04:16', 'assm2-vip', 'IT1', 'Mega', 'vip', 'HELM', 'Triyono', 'ika', 'CPU Bunyi kasar', 'Harddisk Hampir Crash', 'CO', '2017-07-15 12:11:59', 'GPHELM/2017-07/0001', NULL, NULL),
('WRVIP/2017-07/0003', '2017-07-15 13:42:45', 'hrd-vip', 'IT1', 'sholicha', 'vip', 'VIP', 'Ika', 'ika', 'apa', 'hahahha', 'CO', '2017-07-15 13:51:38', 'GPVIP/2017-07/0001', 'PRVIP/2017-07/0001', NULL);
...
--
-- Dumping data untuk tabel `wrschedule`
--
...
('WRVIP/2017-05/0007', '2017-07-06', 'vip', 'HELM', 1),
('WRVIP/2017-05/0007', '2017-07-06', 'vip', 'HELM', 2),
('WRVIP/2017-05/0007', '2017-07-06', 'vip', 'HELM', 2),
('WRVIP/2017-07/0002', '2017-07-15', 'vip', 'HELM', 1),
('WRVIP/2017-07/0001', '2017-07-15', 'vip', 'HELM', 1),
('WRVIP/2017-07/0003', '2017-07-15', 'vip', 'VIP', 1),
('WRVIP/2017-05/0007', '2017-07-15', 'vip', 'HELM', 2),
('WRVIP/2017-07/0003', '2017-07-15', 'vip', 'VIP', 2),
('WRVIP/2017-04/0002', '2017-07-15', 'vip', 'VIP', 2),
('WRVIP/2017-04/0002', '2017-07-15', 'vip', 'VIP', 2),
('WRVIP/2017-04/0002', '2017-07-15', 'vip', 'VIP', 2),
('WRVIP/2017-05/0006', '2017-07-15', 'vip', 'HELM', 1),
('WRVIP/2017-04/0002', '2017-07-15', 'vip', 'VIP', 2),
('WRVIP/2017-04/0002', '2017-07-15', 'vip', 'VIP', 3);
