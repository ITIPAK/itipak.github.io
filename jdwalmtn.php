		...
		<div align="right"><font face="arial" size="2">FO-IT-02.00</font></div>
			<table width="100%" border="1" rules="all" bordercolor="#000000" align="center">
				...
				<tr>
					...
					<td align="center">
						<font face="Arial" size="3"><b>Pelaksanaan Perawatan Komputer</b><br>
						(Action of Computers Maintenance)						
						</font>
					</td>
			...
			<?php
			$div = "select * from msdivisi where idcompany = '$company'";
			...
			<table border="0">
				<tr>
					...
					<td align="justify"><font face="arial" size="1"><?php echo "$hdiv[iddivisi]"; ?></font></td>
				</tr>
			...
			<table width="100%" rules="all" border="1" bordercolor="#000000">
				...
				<?php
					...
					<tr align="justify">
						...
						<td><font face="arial" size="2"><?php echo "$haction[actiondate]"; ?></font></td>
