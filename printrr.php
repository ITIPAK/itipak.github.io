...
<table border="0" width="500">
	<tr>
		<td align="center"><font face="arial" size="2"><strong><em>Receiving Report</em><br>
<?php echo "$no"; ?>
</strong></font></td>
	</tr>
</table>
	...
	<tr>
		<th colspan="5">
			<table align="left" width="100%">
				<tr align="justify">
					<th width="15%" valign="top"><font face="arial" size="1"><strong>PR No.<br> </strong></font></th>
					<th width="1%" valign="top"><font face="arial" size="1"><strong>:</strong></font></th>
					<td width="39%" valign="top"><font face="arial" size="1"><?php echo "$hgetrrh[nopr]"; ?></font></td>
					
					<th width="14%" valign="top"><font face="arial" size="1"><strong>Tanggal</strong></font></th>
					<th width="1%" valign="top"><font face="arial" size="1"><strong>:</strong></font></th>
					<td width="25%" valign="top"><font face="arial" size="1"><?php $printdate = date("d F Y", strtotime($hgetrrh[tanggal])); echo "$printdate"; ?></font><br>
<br>
</td>
				</tr>
	...
	<?php
	$getrrd = "select * from trrrdt where norr = '$no'";
	$qgetrrd = mysql_query($getrrd);
	$n=1;
	while ($hgetrrd = mysql_fetch_array($qgetrrd))
	{
	?>
	<tr align="center">
		<td><font face="arial" size="1"><?php echo "$n"; ?></font></td>
		<?php
			$cpu = "select * from mspart where idpart = '$hgetrrd[idpart]'";
			$qcpu = mysql_query($cpu);
			$hcpu = mysql_fetch_array($qcpu);
			
			$unit = "select * from msunit where idunit = '$hgetrrd[idunit]'";
			$qunit = mysql_query($unit);
			$hunit = mysql_fetch_array($qunit);
		?>
		<td align="justify"><font face="arial" size="1"><?php echo "$hcpu[part]"; ?></font></td>
		<td><font face="arial" size="1"><?php echo "$hgetrrd[qty]"; ?></font></td>
		<td><font face="arial" size="1"><?php echo "$hunit[unit]"; ?></font></td>
		<td align="justify"><font face="arial" size="1"><?php echo "$hgetrrd[remark]"; ?></font></td>
	</tr>
	<?php
	$n++;
	}
