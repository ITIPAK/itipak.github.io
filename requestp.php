...
<table width="900" align="center">
		...
		<table width="900" align="center">
			...
			<tr align="center" bgcolor="#CCCCCC">
				...
				<th width="6%"><font face="Arial" size="1"><b>Accept By</b></font></th>
				<th width="9%"><font face="Arial" size="1"><b>Schedule Date</b></font></th>
				...
				<th width="11%" colspan="3"><font face="Arial" size="1"><b>Action</b></font></th>	
			</tr>
			<?php
			$getwr = "select * from trwr where status = 'P' order by nowr";
			...
			<tr align="justify">
				...
				<?php				
				$getschedule = "select * from wrschedule where nowr = '$hgetwr[nowr]' order by schedule desc";
				$qgetschedule = mysql_query($getschedule);
				$hgetschedule = mysql_fetch_array($qgetschedule);
				
				$getaction = "select * from actionwr where nowr = '$hgetwr[nowr]' order by schedule desc";
				$qgetaction = mysql_query($getaction);
				$hgetaction = mysql_fetch_array($qgetaction);
				if ($hgetschedule[schedule]==$hgetaction[schedule])
				{
				?>	
					<td colspan="1"><font face="Arial" size="1"><a href="<?php echo "requesth.php?wr=$hgetwr[nowr]&div=$hgetwr[iddivisi]"; ?>">Pick Again</a></font></td>
				<?php	
				}
				else
				{
				?>
					<td colspan="1"><font face="Arial" size="1"><a href="<?php echo "actionwr.php?no=$hgetwr[nowr]"; ?>">Action WR</a></font></td>
				<?php
				}
				?>	
					
				<?php
				if (!empty($hgetschedule[schedule]))
				{
				?>	
					<td colspan="1"><font face="Arial" size="1"><a href="<?php echo "getpart.php?no=$hgetwr[nowr]"; ?>">Get Spare Part</a></font></td>
					<td colspan="1"><font face="Arial" size="1"><a href="<?php echo "trpr.php?no=$hgetwr[nowr]"; ?>">Create PR</a></font></td>
				<?php
				}
				else
				{
