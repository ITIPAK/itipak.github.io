...
try {
	...
	$mail->AddReplyTo($htech1[email], 'Support Ticket'); 
    $mail->AddAddress($hmaillead[email], 'Leader of '.$divisi); // isi alamat tujuan email, NB : khusus untuk mengirim dari gmail ke yahoo agak lama
	...
	<body>
	  ...
	  <table border=1 width=750>
		...
		<tr>
		  ...
		  <th width=15% align=left><font face=arial size=1>Request to</th><th width=5% align=justify>:</th> <th width=30% align=left><font face=arial size=1>".$htech1[tech]."</font></th>
		</tr>
